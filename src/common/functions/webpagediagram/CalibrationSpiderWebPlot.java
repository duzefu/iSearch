...
public class CalibrationSpiderWebPlot extends SpiderWebPlot { 
    ...
    private static final double TICK_SCALE = 0.045;  //�̶��߳���
    private int valueLabelGap = DEFAULT_GAP; 
    private static final int DEFAULT_GAP = 10; 
    private static final double THRESHOLD = 15; 
    public static final int DEFAULT_TICKS = 5; //�̶�ԲȦ��
    public static final double DEFAULT_MAX_VALUE = 100; //�������ֵ
    public static final boolean DEFAULT_DRAW_RING = true; //����Ĭ��ֵ
   ...
   public CalibrationSpiderWebPlot(CategoryDataset createCategoryDataset) { 
            this(createCategoryDataset,DEFAULT_MAX_VALUE); //�����������ֵΪĬ�ϵ�ֵ
    } 
   ...
   public CalibrationSpiderWebPlot(CategoryDataset createCategoryDataset,double maxValue) { 
	   this(createCategoryDataset,maxValue,DEFAULT_DRAW_RING); //���û���Ĭ��ֵ
   } 
   ...
   public CalibrationSpiderWebPlot(CategoryDataset createCategoryDataset,double maxValue,boolean drawRing) { 
	   this(createCategoryDataset,maxValue,drawRing,DEFAULT_TICKS);//���ÿ̶���Ĭ��ֵ
   } 
   ...
   public CalibrationSpiderWebPlot(CategoryDataset createCategoryDataset,double maxValue,boolean drawRing,int ticks) { 
	   this(createCategoryDataset,maxValue,drawRing,ticks,"");//���ÿ̶�ǰ׺Ĭ��ֵ
   } 
   ...
   public CalibrationSpiderWebPlot(CategoryDataset createCategoryDataset,double maxValue,boolean drawRing,int ticks,String lablePrefix) { 
	   this(createCategoryDataset,maxValue,drawRing,ticks,lablePrefix,"");;//���ÿ̶Ⱥ�׺Ĭ��ֵ
   } 
   ...
   public CalibrationSpiderWebPlot(CategoryDataset createCategoryDataset,double maxValue,boolean drawRing,int ticks,String lablePrefix,String lableSuffix) { 
	   ...
	   this.setMaxValue(maxValue);//�����������ֵ
	   this.setDrawRing(drawRing);//���û���
	   this.setTicks(ticks);//���ÿ̶���
	   this.setLablePrefix(lablePrefix);//�̶�ǰ׺
	   this.setLableSuffix(lableSuffix);//�̶Ⱥ�׺
   } 
   ...
   public void draw(Graphics2D g2, Rectangle2D area, Point2D anchor,
       ...
       if (!DatasetUtilities.isEmptyOrNull(this.getDataset())) {
           ...
           //����
           if(this.isDrawRing()){
	           Point2D topPoint = getWebPoint(radarArea, 90, 1);//��90��Ϊ���ģ��������Բ����x��y����
	           double topPointR = centre.getY() - topPoint.getY() ;//���Ķ���Բ�İ뾶
	           double step = topPointR/this.getTicks();//ÿ���̶ȵİ뾶��
				...
				for (int p = this.getTicks(); p >= 1; p--) {
			    	   ...
			    	   double d = 2 * r;
						...
						g2.setPaint(Color.cyan);  //����Բ������ɫ������Բ���ı������ֱ��g2��Graphics2D��
						g2.draw(ring);				
				}
           }
